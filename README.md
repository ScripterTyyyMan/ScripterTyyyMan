...
function lib:Gui(title)
	...
	TabSide.Parent = Main
	TabSide.BackgroundColor3 = Color3.fromRGB(0,0,255)
	...
	function Tabs:Tab(name)
		...
		function Sections:Section(name)
			...
			function Elements:Toggle(name, callback)
				...
				ToggleElement.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
local Library = lib:Gui("TigerVo1dHaxx")

local AutoFarmTab = Library:Tab("🏠Main")

local AutoFarm = AutoFarmTab:Section("🏠Main")
...
Teleport:Button("Sky Island", function()
	local New_CFrame = CFrame.new(-4467, 44194, -32905)
...
Misc:Button("UrMomGUI", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/XCXxhZht", true))()
end)

Misc:Button("Limiteds", function()
	loadstring(game:HttpGet("https://pastebin.com/raw/H5yx10Jq", true))()
end)
